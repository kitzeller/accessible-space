Rock = function(size, scene, sd) {
    ...
    var rockColor = randomColor({hue: 'blue', luminosity: 'dark', format: 'rgbArray'});

    rock.material = new BABYLON.StandardMaterial("mat", scene);
    rock.material.diffuseColor = BABYLON.Color3.FromInts(rockColor[0],rockColor[1],rockColor[2]);
    rock.material.specularColor = BABYLON.Color3.Black();
    rock.position.y = 0;
    rock.resourceType = 'rock';
    rock.canDestroy = true;
    rock.isPickable = true;
    rock.checkCollisions = true;
    // sd.getShadowMap().renderList.push(rock);
